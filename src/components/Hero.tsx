...
const Hero = () => {
  return (
    <section id="hero" className="min-h-screen flex items-center justify-center relative bg-gradient-to-br from-blue-50 to-indigo-100">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between">
          ...
          >
            <h1 className="text-4xl md:text-6xl font-bold mb-4">
              ...
              <span className="text-blue-600 block mt-2">Shakthi Chaithanya Tirupati</span>
            </h1>
            <h2 className="text-xl md:text-2xl text-gray-700 mb-6">
              Software Developer
            </h2>
            <p className="text-gray-600 mb-8 max-w-lg">
              I craft exceptional digital experiences by building robust, scalable, and secure backend systems with clean code and efficient architecture. Let's bring your ideas to life with powerful backend solutions.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
              ...
              >
                <Link to="projects" spy={true} smooth={true} offset={-30} duration={200}>
                  View Projects
                </Link>
              </motion.button>
            </div>
